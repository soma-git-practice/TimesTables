...
RSpec.describe TimesTables do
  ...
  context 'クラスメソッド' do
    it 'wrap_array_with_mark' do
      expect(TimesTables.wrap_array_with_mark([1, 2, 3])).to eq '|1|2|3|'
    end

    it 'length_ja' do
      expect(TimesTables.length_ja('aあ7&い')).to eq 7
    end

    it 'cjust' do
      expect(TimesTables.cjust('aあ7&い', 10)).to eq '  aあ7&い '
    end
    ...
    context '0埋め有り' do
      ...
      it 'import_csv' do
        ...
        # ファイル内の情報のテスト
        expect(TimesTables.import_csv(test_path)).to eq "|   段  | 1の位 | 2の位 | 3の位 | 4の位 |\n|   01  |   01  |   02  |   03  |   04  |\n|   02  |   02  |   04  |   06  |   08  |\n|   03  |   03  |   06  |   09  |   12  |\n|   04  |   04  |   08  |   12  |   16  |"
        # テストで使用したファイルの削除
